...
def select_by_timestamp(
    ...
    """Select a portion of a raw_dataset based on timestamps.
...
def select_by_index(
    ...
    """Select a portion of a raw_dataset based on integer indices into the data.
...
def select_by_relative_fraction(
    ...
    """Select a portion of a raw_dataset based on relative fractions of the data.
    Note that the range selected is inclusive of the starting index. When ID columns are specified
...
def select_by_fixed_fraction(
    ...
    """Select a portion of a raw_dataset based on a fraction of the data.
...
def convert_to_univariate(
    ...
    """Converts a dataframe in canonical format to a univariate raw_dataset. Adds an additional id column to
